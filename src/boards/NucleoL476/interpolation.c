...
static void set_point(float *p, uint8_t rows, uint8_t cols, int8_t x, int8_t y, float f);
static float get_point(float *p, uint8_t rows, uint8_t cols, int8_t x, int8_t y);
